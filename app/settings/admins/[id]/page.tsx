...
const permissionGroups = [
  ...
  {
    title: '회원관리',
    items: ['일반회원관리', '탈퇴회원관리', '회원등급관리', '이메일 관리', 'SMS 관리'],
  },
  {
    title: '환경설정',
    items: ['팝업관리', '약관및정책관리', '환경설정', '운영자계정관리', '추천 검색어', '아이피 차단'],
  },
  {
    title: '통계관리',
    items: ['매출분석', '회원및 방문분석'],
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">직원정보 수정</h1>
            </div>
          </div>
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-6 py-4">
                  <Input value={userId} disabled className="bg-gray-50 max-w-md" />
                </td>
                <td className="px-6 py-4 bg-gray-50 font-medium text-sm text-gray-700 w-48">
                  비밀번호
                </td>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="px-6 py-4">
                  <Select
                    value={status}
                    onValueChange={(value) => setStatus(value as '이용중' | '정지중')}
                  >
                ...
                <td className="px-6 py-4" colSpan={3}>
                  <div className="space-y-4">
                    <div className="flex gap-2 mb-4">
                      <Button onClick={handleSelectAllPermissions} variant="outline" size="sm">
                        전체선택
                      </Button>
                      <Button onClick={handleClearAllPermissions} variant="outline" size="sm">
                        선택취소
                      </Button>
                    </div>
                    <table className="w-full border border-gray-300">
                      <tbody>
                        {permissionGroups.map((group, groupIndex) => (
                          <tr key={groupIndex} className="border-b border-gray-300 last:border-0">
